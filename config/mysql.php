...
class Mysql
{
     ...
     *          - $table = The table you want <span class="IL_AD" id="IL_AD2">to return</span> information from.
        ...
        $recordSet =
            mysql_query(
                ...
                "Selecting $table - SELECT $fields FROM $table"  . $where . $orderby . $limit .
                    ...
                    //    <span class="IL_AD" id="IL_AD12">print this</span> string to the screen.
            );
