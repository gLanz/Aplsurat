...
{
	$max_dimension = 920; // Max new width or height, can not exceed this value.
	$dir = "../../assets/slider/"; // Directory to save resized image. (Include a trailing slash - /)
...
if($postvars["image_size"] <= 1000000){
